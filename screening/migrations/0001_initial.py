    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scores', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='results', to='screening.questionarydimensionscore')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answers', models.ManyToManyField(blank=True, to='screening.questionaryanswer')),
