...
urlpatterns = [
    ...
    path("questionaries/categories/", views.CategoryScreeningReadOnlyViewSet.as_view({'get': 'alist'}), name="questionaries-categories"),
    path("questionaries/category/<int:pk>/", views.CategoryScreeningReadOnlyViewSet.as_view({'get': 'aretrieve'}), name="questionaries-category"),
