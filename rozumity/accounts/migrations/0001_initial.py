# Generated by Django 5.1.6 on 2025-05-14 09:53
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ClientProfile',
            fields=[
                ('id', models.OneToOneField(editable=False, help_text='User Email', on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL, to_field='email')),
                ...
                ('date_birth', models.DateField(blank=True, default=datetime.date(2007, 5, 19), null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date_start', models.DateTimeField(default=django.utils.timezone.now)),
                ('client_subscription_id', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT, related_name='client_contract', to='accounts.subscriptionplan')),
                ('expert_subscription_id', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT, related_name='expert_contract', to='accounts.subscriptionplan')),
